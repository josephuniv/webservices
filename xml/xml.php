<?php
  ...
  //Creating the student element and adding it to the DOM object
  // $dom->appendChild($dom->createElement('student'));
  $student = $dom->createElement('student');
  $dom->appendChild($student);
      // Appending the above created $student to the object creates the following: <student></student>

      //Adding the course to the student
